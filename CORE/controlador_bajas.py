...
#             "centroEnvion": str(datos.get("centroEnvion", centro_envion_configurado)).strip() or centro_envion_configurado,
...
#         - centroEnvion se toma desde 'origen'
#         - sede se toma desde 'nombreSede'
#         - coordinadora se toma desde 'coordinadora'
#         """
#         configuracion = self._cargar_configuracion_sede()
...
class ControladorBajas(QObject):
    ...
    def obtenerConfiguracionBaja(self) -> dict[str, Any]:
        ...
        - sede se toma desde 'nombreSede'
        - coordinadora se toma desde 'coordinadora'
        - profesionalesIntervinientes se toma desde configuración
        """
        configuracion = self._cargar_configuracion_sede()
