...
# def error_validacion(mensaje: str) -> None:
#     raise PydanticCustomError(
#         "jade_validacion",
#         mensaje,
#     )
...
#     if valor == "":
#         error_validacion(f"{campo}: es obligatorio.")
...
#         error_validacion(f"{campo}: debe contener solo dígitos.")

#     if int(valor) <= 0:
#         error_validacion(f"{campo}: debe ser mayor a cero.")
...
# #     if not valor.isdigit():
# #         raise ValueError(f"{campo}: debe contener solo dígitos.")
...
#             valor=valor,
#             patron=PATRON_TEXTO_PERSONA,
#             mensaje="Rol: solo permite letras, acentos y espacios.",
#         )
...
#             valor=valor,
#             patron=PATRON_SIGLAS,
#             mensaje="Siglas del rol: solo permite letras mayúsculas.",
#         )
...
#             valor=valor,
#             patron=PATRON_TEXTO_PERSONA,
#             mensaje="Municipio: solo permite letras, acentos y espacios.",
#         )
...
#             valor=valor,
#             patron=PATRON_TEXTO_PERSONA,
#             mensaje="Localidad: solo permite letras, acentos y espacios.",
#         )
...
#             valor=valor,
#             patron=PATRON_TEXTO_CON_NUMEROS,
#             mensaje="Barrio: solo permite letras, números, acentos y espacios.",
#         )
...
#             valor=valor,
#             patron=PATRON_TEXTO_CON_NUMEROS,
#             mensaje="Calle: solo permite letras, números, acentos y espacios.",
#         )
...
#             valor=valor,
#             patron=PATRON_NUMERO_DOMICILIO,
#             mensaje="Número de domicilio: solo permite números, letras, barra / y guion -, sin espacios.",
#         )
...
#         if len(valor) < 4 or len(valor) > 5:
#             raise ValueError("Código de área: debe tener entre 4 y 5 dígitos.")
