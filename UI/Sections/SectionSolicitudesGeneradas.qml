...
Rectangle {
    ...
    function eliminarSolicitud(ruta) {
        let resultado = controladorConfiguracion.eliminarSolicitudGenerada(ruta)
        console.log("[SECTION SOLICITUDES GENERADAS] eliminar solicitud:", resultado)
        root.mensajeEstado = resultado
                        ...
                        delegate: Rectangle {
                            ...
                            Menu {
                                ...
                                MenuItem {
                                    ...
                                    onTriggered: {
                                        root.eliminarSolicitud(model.rutaArchivo)
                                    }
                                }
                            }
