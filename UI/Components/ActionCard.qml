...
Item {
    ...
    width: 300
    height: JadeLayout.actionCardHeight
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            anchors.margins: JadeLayout.esCompacto
                             ? AppTheme.spacingMd
                             : AppTheme.spacingXl

            spacing: JadeLayout.esCompacto
                     ? AppTheme.spacingMd
                     : AppTheme.spacingXl
            ...
            Rectangle {
                ...
                Layout.preferredWidth: JadeLayout.esCompacto
                                       ? Math.max(48, JadeLayout.actionCardIconSize - 18)
                                       : Math.max(58, JadeLayout.actionCardIconSize - 14)

                Layout.preferredHeight: JadeLayout.esCompacto
                                        ? Math.max(48, JadeLayout.actionCardIconSize - 18)
                                        : Math.max(58, JadeLayout.actionCardIconSize - 14)
                ...
                Text {
                    ...
                    font.pixelSize: JadeLayout.esCompacto
                                    ? Math.max(18, JadeLayout.actionCardIconFontSize - 4)
                                    : JadeLayout.actionCardIconFontSize
            ...
            Column {
                ...
                Text {
                    ...
                    font.family: AppTheme.fuenteTitulo
                    font.pixelSize: JadeLayout.actionCardTitleSize
                ...
                Text {
                    ...
                    font.pixelSize: JadeLayout.actionCardDescriptionSize
                    font.weight: AppTheme.pesoTextoSecundario

                    lineHeight: 1.25
                    wrapMode: Text.WordWrap
                    maximumLineCount: JadeLayout.esCompacto ? 3 : 4
                    elide: Text.ElideRight
                }
            }
        }
